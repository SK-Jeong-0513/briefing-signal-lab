...
const UI = {
  ...
  /* 주간 딥다이브 — 기술·금융·경제 세 페이지가 공용으로 쓴다.
   * 밸류체인·관전포인트 라벨은 카테고리마다 말이 달라(밸류체인/관련 자산/영향 자산)
   *   각 페이지 UI 의 valueChainLabel·watchLabel 을 그대로 쓴다. */
  deepdive: {
    heading: { ko: "이번 주 딥다이브", en: "This week's deep-dives" },
    sub: {
      ko: "이번 호 신호 중 선행성과 파급범위가 가장 높은 3건을 골라 메커니즘까지 풀었습니다.",
      en: "The three signals from this issue that scored highest on lead time and reach, unpacked to the mechanism.",
    },
    leadLabel: { ko: "선행성", en: "Lead" },
    reachLabel: { ko: "파급범위", en: "Reach" },
    basisLabel: { ko: "근거", en: "Basis" },
    sourceLabel: { ko: "원문 →", en: "Source →" },
  },
  compare: {
  ...
  techPage: {
    ...
    intro: {
      ko: "기술을 돈의 흐름으로 읽는 투자자를 위한 주간 브리핑입니다. 1차 소스에서 경제지 헤드라인보다 먼저 잡은 선행 신호를, 어느 밸류체인 기업으로 이어지는가까지 연결합니다. 분야를 골라 구독하세요 — 지금은 전부 무료입니다.",
      en: "A weekly briefing for investors who read technology as a flow of capital. We catch leading signals from primary sources before the headlines and connect them to the value chain. Pick a domain to follow — everything is free right now.",
    },
    ...
    digestNote: { ko: "매주 월요일 아침, 이번 주 신호를 메일로 먼저 받아보세요.", en: "Get this week's signals by email first, every Monday morning." },
    ...
    paidEyebrow: { ko: "PAID · 향후 진행", en: "PAID · COMING LATER" },
    paidTitle: { ko: "지금은 전부 무료입니다", en: "Everything is free right now" },
    // ⚠ 유료 전용 기능 목록을 적지 않는다 — 아직 정해지지 않았고,
    //   지금 무료로 주는 항목을 유료 칸으로 옮기면 랜딩 비교표와 모순된다.
    paidBody: {
      ko: "서비스를 다듬는 동안 모든 브리핑을 무료로 제공합니다. 약 1년간 운영하며 개선한 뒤 유료 구독 도입을 검토할 예정이며, 도입하게 되면 미리 안내드립니다.",
      en: "Everything stays free while we refine the service. After about a year of operation and improvement we may introduce a paid tier — with notice well in advance.",
    },
    paidCta: { ko: "준비 중", en: "Coming later" },
    paidNote: {
      ko: "정보 제공·투자 조언 아님. 밸류체인 기업은 관찰 대상으로 명시하며 매수·매도·목표가를 권유하지 않습니다.",
      en: "Information only, not investment advice. Value-chain companies are named as observation targets; we do not recommend buying or selling.",
    },
  },
  financePage: {
    ...
    intro: {
      ko: "종목·자산·수급을 보는 투자자를 위한 주간 금융 브리핑입니다. 자산군(분야)을 골라 구독하세요 — 지금은 전부 무료입니다. 정보 제공이며 투자 조언이 아닙니다.",
      en: "A weekly finance briefing for investors watching names, assets, and flows. Pick an asset-class domain — everything is free right now. Information only, not investment advice.",
    },
    feedHeading: { ko: "이번 주 브리핑", en: "This week's briefing" },
    ...
    paidTitle: { ko: "지금은 전부 무료입니다", en: "Everything is free right now" },
    paidBody: {
      ko: "서비스를 다듬는 동안 모든 브리핑을 무료로 제공합니다. 약 1년간 운영하며 개선한 뒤 유료 구독 도입을 검토할 예정이며, 임의로 바꾸지 않고 미리 안내드립니다.",
      en: "Everything stays free while we refine the service. After about a year of operation and improvement we may introduce a paid tier — with notice well in advance.",
    },
    paidCta: { ko: "준비 중", en: "Coming later" },
    paidNote: {
      ko: "정보 제공·투자 조언 아님. 종목·자산은 관찰 대상으로 명시하며 매수·매도·목표가를 권유하지 않습니다.",
      en: "Information only, not investment advice. Names/assets are named as observation targets; no buy/sell recommendation.",
    },
  },
  economyPage: {
    ...
    intro: {
      ko: "금리 결정·물가·고용·무역/환율 등 매크로를 한 번에 읽는 주간 경제 브리핑입니다. 지금은 전부 무료입니다. 정보 제공이며 투자 조언이 아닙니다.",
      en: "A weekly macro briefing reading rate decisions, inflation, jobs, and trade/FX in one place. Everything is free right now. Information only, not investment advice.",
    },
    ...
    paidCta: { ko: "준비 중", en: "Coming later" },
    paidNote: {
      ko: "정보 제공·투자 조언 아님. 지표·자산은 관찰 대상으로 명시하며 매수·매도를 권유하지 않습니다.",
      en: "Information only, not investment advice. Indicators/assets are named as observation targets; no buy/sell recommendation.",
    },
  },
  dashboardPage: {
